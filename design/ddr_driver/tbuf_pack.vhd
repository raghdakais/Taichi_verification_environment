...
package tbuf_pack is
  ...
  -- constant EV_DATA_END_ADDR    : unsigned(DDR3_ADDR_WIDTH-1 downto 0) := resize(X"00004200", DDR3_ADDR_WIDTH);		-- !debug: 09/01/2025 temporary reduced for EV buffer overflow test
