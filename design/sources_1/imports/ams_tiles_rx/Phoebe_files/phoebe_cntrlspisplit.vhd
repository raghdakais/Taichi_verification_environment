...
BEGIN
  ...
  begin  -- process overhead_pr
    if (clk'event and clk = '1') then  -- rising clock edge
      ...
      overhead_bits(63 downto 60) <= init_seq_end(3) & init_seq_end(2) & init_seq_end(1) & init_seq_end(0); -- note: must be muxed init_seq_end and Tile_data_locked -> [63..60] number of tiles
      ...
      -- overhead_bits(59 downto 56) <= calib_monitor_reg(0)(13) & calib_monitor_reg(0)(6) &
      --                                calib_monitor_reg(0)(4) & calib_monitor_reg(0)(7);
      -- overhead_bits(55 downto 52) <= calib_monitor_reg(1)(13) & calib_monitor_reg(1)(6) &
      --                                calib_monitor_reg(1)(4) & calib_monitor_reg(1)(7);
      -- overhead_bits(51 downto 48) <= calib_monitor_reg(2)(13) & calib_monitor_reg(2)(6) &
      --                                calib_monitor_reg(2)(4) & calib_monitor_reg(2)(7);
      -- overhead_bits(47 downto 44) <= calib_monitor_reg(3)(13) & calib_monitor_reg(3)(6) &
      --                                calib_monitor_reg(3)(4) & calib_monitor_reg(3)(7);
