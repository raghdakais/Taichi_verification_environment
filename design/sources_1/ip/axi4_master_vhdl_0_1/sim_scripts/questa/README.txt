...
#
# Generated by export_simulation on Tue Sep 13 16:40:10 +0300 2022
#
################################################################################
...
'-reset_run' switch to the './axi4_master_vhdl_0.sh' script.

./axi4_master_vhdl_0.sh -reset_run
...
./axi4_master_vhdl_0.sh -noclean_files

For more information on the script, please type './axi4_master_vhdl_0.sh -help'.
