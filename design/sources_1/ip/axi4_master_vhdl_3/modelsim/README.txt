...
#
# Generated by export_simulation on Tue Aug 30 16:28:23 +0300 2022
#
################################################################################
...
'-reset_run' switch to the './axi4_master_vhdl_3.sh' script.

./axi4_master_vhdl_3.sh -reset_run
...
./axi4_master_vhdl_3.sh -noclean_files

For more information on the script, please type './axi4_master_vhdl_3.sh -help'.
