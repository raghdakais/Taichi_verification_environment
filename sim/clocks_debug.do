...
add wave -noupdate -group SYNC_HEADER /taichi_tmb_tb/DUT/IP_DATAVAL_HEADER_TOP_1/HEADER_DATA_OUT
add wave -noupdate -group SYNC_HEADER -color Cyan /taichi_tmb_tb/DUT/IP_DATAVAL_HEADER_TOP_1/S_RX_det_o
add wave -noupdate -group SYNC_HEADER -color {Orange Red} /taichi_tmb_tb/DUT/IP_DATAVAL_HEADER_TOP_1/FOOTER_CTRL_1/F_ADDRA_R
add wave -noupdate -group SYNC_HEADER -color {Orange Red} /taichi_tmb_tb/DUT/IP_DATAVAL_HEADER_TOP_1/FOOTER_CTRL_1/F_DOUT
add wave -noupdate -group SYNC_HEADER /taichi_tmb_tb/DUT/IP_DATAVAL_HEADER_TOP_1/FOOTER_CTRL_1/fq_stream_enable
add wave -noupdate -group SYNC_HEADER /taichi_tmb_tb/DUT/IP_DATAVAL_HEADER_TOP_1/FOOTER_CTRL_1/fs_merging_factor
add wave -noupdate -group SYNC_HEADER /taichi_tmb_tb/DUT/IP_DATAVAL_HEADER_TOP_1/FOOTER_CTRL_1/fs_sequence_counter
add wave -noupdate -group SYNC_HEADER /taichi_tmb_tb/DUT/IP_DATAVAL_HEADER_TOP_1/FOOTER_CTRL_1/GOOD_PACKET_RECEIVED
add wave -noupdate -group SYNC_HEADER /taichi_tmb_tb/DUT/IP_DATAVAL_HEADER_TOP_1/FOOTER_CTRL_1/hd_ptr_address_from_sync
add wave -noupdate -group SYNC_HEADER /taichi_tmb_tb/DUT/IP_DATAVAL_HEADER_TOP_1/FOOTER_CTRL_1/rlt_address_from_sync
add wave -noupdate -group SYNC_HEADER /taichi_tmb_tb/DUT/IP_DATAVAL_HEADER_TOP_1/FOOTER_CTRL_1/slice_merging_factor
add wave -noupdate -group SYNC_HEADER -color Khaki -radix hexadecimal /taichi_tmb_tb/DUT/IP_DATAVAL_HEADER_TOP_1/temp_Num_of_Slices
add wave -noupdate -divider <NULL>
...
add wave -noupdate -expand -group {DATA OUT } /taichi_tmb_tb/DUT/use_ddr3_phy_g/ddr_driver_1/read_ddr3_rd_1/fifo_dc_2k_32_1/dout
add wave -noupdate -expand -group {DATA OUT } /taichi_tmb_tb/DUT/use_ddr3_phy_g/ddr_driver_1/read_ddr3_rd_1/fifo_dc_2k_32_1/empty
add wave -noupdate -expand -group {DATA OUT } /taichi_tmb_tb/DUT/use_ddr3_phy_g/ddr_driver_1/read_ddr3_rd_1/fifo_dc_2k_32_1/full
add wave -noupdate -expand -group {DATA OUT } /taichi_tmb_tb/DUT/use_ddr3_phy_g/ddr_driver_1/read_ddr3_rd_1/fifo_dc_2k_32_1/rd_clk
add wave -noupdate -expand -group {DATA OUT } /taichi_tmb_tb/DUT/use_ddr3_phy_g/ddr_driver_1/read_ddr3_rd_1/fifo_dc_2k_32_1/rd_data_count
add wave -noupdate -expand -group {DATA OUT } /taichi_tmb_tb/DUT/use_ddr3_phy_g/ddr_driver_1/read_ddr3_rd_1/fifo_dc_2k_32_1/rd_en
add wave -noupdate -expand -group {DATA OUT } /taichi_tmb_tb/DUT/use_ddr3_phy_g/ddr_driver_1/read_ddr3_rd_1/fifo_dc_2k_32_1/rd_rst
add wave -noupdate -expand -group {DATA OUT } /taichi_tmb_tb/DUT/use_ddr3_phy_g/ddr_driver_1/read_ddr3_rd_1/fifo_dc_2k_32_1/valid
add wave -noupdate -expand -group {DATA OUT } /taichi_tmb_tb/DUT/use_ddr3_phy_g/ddr_driver_1/read_ddr3_rd_1/fifo_dc_2k_32_1/wr_clk
add wave -noupdate -expand -group {DATA OUT } /taichi_tmb_tb/DUT/use_ddr3_phy_g/ddr_driver_1/read_ddr3_rd_1/fifo_dc_2k_32_1/wr_data_count
add wave -noupdate -expand -group {DATA OUT } /taichi_tmb_tb/DUT/use_ddr3_phy_g/ddr_driver_1/read_ddr3_rd_1/fifo_dc_2k_32_1/wr_en
add wave -noupdate -expand -group {DATA OUT } /taichi_tmb_tb/DUT/use_ddr3_phy_g/ddr_driver_1/read_ddr3_rd_1/fifo_dc_2k_32_1/wr_rst
...
WaveRestoreCursors {{Cursor 2} {1154029229 ps} 0} {{Cursor 2} {13088959013 ps} 0}
...
update
WaveRestoreZoom {1154004146 ps} {1154099215 ps}
