...
add wave -noupdate -group {Sig2 Sync} /taichi_tmb_tb/DUT/registers_inst_A/S_TX_IN
...
add wave -noupdate -divider <NULL>
add wave -noupdate -expand -group ASIC_TILES /taichi_tmb_tb/DUT/SYNC
add wave -noupdate -expand -group ASIC_TILES /taichi_tmb_tb/DUT/TILES_CLK
add wave -noupdate -expand -group ASIC_TILES /taichi_tmb_tb/DUT/TILES_CLK_N
add wave -noupdate -expand -group ASIC_TILES /taichi_tmb_tb/DUT/SCLK
add wave -noupdate -expand -group ASIC_TILES /taichi_tmb_tb/DUT/SCS1
add wave -noupdate -expand -group ASIC_TILES /taichi_tmb_tb/DUT/SCS2
add wave -noupdate -expand -group ASIC_TILES /taichi_tmb_tb/DUT/SDI
add wave -noupdate -expand -group ASIC_TILES /taichi_tmb_tb/DUT/SDO
add wave -noupdate -expand -group ASIC_TILES /taichi_tmb_tb/DUT/ACO
add wave -noupdate -expand -group ASIC_TILES /taichi_tmb_tb/DUT/ACO_N
add wave -noupdate -expand -group ASIC_TILES /taichi_tmb_tb/DUT/DATA1
add wave -noupdate -expand -group ASIC_TILES /taichi_tmb_tb/DUT/DATA1_N
add wave -noupdate -expand -group ASIC_TILES /taichi_tmb_tb/DUT/DATA2
add wave -noupdate -expand -group ASIC_TILES /taichi_tmb_tb/DUT/DATA2_N
add wave -noupdate -divider <NULL>
...
WaveRestoreCursors {{Cursor 3} {67920033 ps} 0}
...
update
WaveRestoreZoom {0 ps} {182185500 ps}
