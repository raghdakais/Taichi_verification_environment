...
//===============================================================================
class diagnostic_check_default_test extends taichi_tmb_test_base;
//===============================================================================
    // Testbench configuration and stimulus generation
       `uvm_component_utils(diagnostic_check_default_test)  // Register with the factory
  

        // This is standard code for all components
    function new (string name = "diagnostic_check_default_test", uvm_component parent = null);
