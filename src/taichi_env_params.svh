...
reg_t OPER_REGISTERS [] = '{
    ...
    '{32'h4066B0, 1, 32'h00000003},  // Module Power APOS, ANEG Disable (Enabled by PowerUp S.M.) (R/W)
    '{32'h406700, 1, 32'h000bf173},  // Mu control (R/W)
    '{32'h406710, 1, 32'h00000000},  // Add constant offset to charge input - in Mu calculation (R/W)
    '{32'h406730, 1, 32'h00000000},  // Asics Test/Calibration control (R/W)
    '{32'h406740, 0, 32'h00000000},  // Asics Test Results (R)
    '{32'h406750, 1, 32'h00000000},  // Miscellaneous (R/W)
    '{32'h406760, 1, 32'h0000007D},  // Global IP coefficient for added Offset normalization (R/W)
    '{32'h406780, 1, 32'h0000000A},  // Asics Master/Slave/Broadcast Asics select for SPI (R/W)
...
reg_t DIAG_REGISTERS [] = '{
    ...
    '{32'h406424, 0, 32'hc00079c7},  // Module Status/Errors register (R)
